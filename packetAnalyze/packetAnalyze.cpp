        ...
        if (rawPDU.payload_size() > 23)
        {
            ...
            std::vector<std::string> DesiredEventCodes = { 
              /*"00000014","00000018","00000041","00000043","00000046","00000048","0000001c","0000001e",
                ...
                // opening tabs
                "00000001","00000048","00000077","00000353","00000356",
                ...
                "00000038","00000039","0000003a","0000003b","0000003c","0000003d","00000040","00000040",
                "00000041","00000042","00000043","00000045","00000047","00000049","0000004a","0000004b",
                "0000004c","0000004d","0000004e","0000004f","00000050","00000051","00000052","00000053",
                "00000054","00000055","00000056","00000058","0000005b","0000005d","0000005e","00000061",
                "00000062","00000063","00000064","00000065","00000068","00000069","0000006a","0000006a",
                "0000006b","0000006c","0000006d","0000006f","00000070","00000071","00000075","00000076",
                ...
                "000001b9","00067800","0009a500","01067800","06067800","07780000"
            ...
            for (size_t i = 0; i < commandBorders.size() - 1; i++)
            {
                    ...
                    eventCode) != std::end(desiredEventCodes)))
                {
                    ...
                    printPacket(rawPDU, commandBorders[i] + 8, commandBorders[i + 1]);
